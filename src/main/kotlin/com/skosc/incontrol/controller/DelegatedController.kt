...
internal class DelegatedController(private val controller: Controller) {
    ...
    private val handler = handlerMethodFinder.findHandlerMethod(controller)
    private val delegatedHandler: ControllerHandlerMethod = ControllerHandlerMethod(handler)
